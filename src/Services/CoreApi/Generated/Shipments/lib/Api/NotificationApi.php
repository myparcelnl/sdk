...
class NotificationApi
{
     ...
     * @throws \MyParcelNL\Sdk\CoreApi\Generated\Shipments\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\NotificationResponsesNotificationGroups|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserError|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesSystemError
     */
    ...
    public function getNotificationGroupsWithHttpInfo($shop_id = null, string $contentType = self::contentTypes['getNotificationGroups'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\NotificationResponsesNotificationGroups' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\NotificationResponsesNotificationGroups' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\NotificationResponsesNotificationGroups', []),
            ...
            $returnType = '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\NotificationResponsesNotificationGroups';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\NotificationResponsesNotificationGroups',
     ...
     * @throws \MyParcelNL\Sdk\CoreApi\Generated\Shipments\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\NotificationResponsesNotificationTemplates|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserError|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesSystemError
     */
     ...
     * @throws \MyParcelNL\Sdk\CoreApi\Generated\Shipments\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\NotificationResponsesNotificationTemplates|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserError|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesSystemError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getNotificationTemplatesWithHttpInfo($notification_group_id, string $contentType = self::contentTypes['getNotificationTemplates'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\NotificationResponsesNotificationTemplates' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\NotificationResponsesNotificationTemplates' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\NotificationResponsesNotificationTemplates', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\NotificationResponsesNotificationTemplates';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\NotificationResponsesNotificationTemplates',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\NotificationPostNotificationGroupRequest $notification_post_notification_group_request Request body for creating notification groups. (required)
     ...
     * @param  int $notification_group_id The ID of the notification group. (required)
     * @param  int $notification_template_id The ID of the notification template. (required)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\NotificationPutNotificationTemplateRequest $notification_put_notification_template_request Request body for updating a notification template. (required)
