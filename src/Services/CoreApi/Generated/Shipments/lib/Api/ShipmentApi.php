...
namespace MyParcelNL\Sdk\CoreApi\Generated\Shipments\Api;
...
use MyParcelNL\Sdk\CoreApi\Generated\Shipments\ApiException;
use MyParcelNL\Sdk\CoreApi\Generated\Shipments\Configuration;
use MyParcelNL\Sdk\CoreApi\Generated\Shipments\HeaderSelector;
...
class ShipmentApi
{
     ...
     * Delete Shipment
     *
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonParametersBigids $ids One or more shipment IDs. Separate multiple shipment IDs using &#x60;;&#x60;. (required)
     ...
     *
     * @throws \MyParcelNL\Sdk\CoreApi\Generated\Shipments\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefTypesCarrier|null $carrier_id carrier_id (optional)
     * @param  \DateTime|null $created When set, only resources created after this date will be returned. Inclusive. (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonParametersBoolean|null $delayed Filter on whether the current event code means the shipment has been delayed. (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonParametersFilterValidateBool|null $delivered delivered (optional)
     ...
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonParametersFilterValidateBool|null $hidden hidden (optional)
     * @param  bool|null $link_consumer_portal link_consumer_portal (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonParametersOrder|null $order Specify whether the results should be sorted in ascending or descending order. (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentParametersPackageType|null $package_type Filter by Package Type. (optional)
     ...
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentParametersShipmentType|null $shipment_type shipment_type (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonParametersIds|null $shop_id shop_id (optional)
     * @param  int|null $size Specify the number of resources returned per page, used for paginated results. (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentParametersSortShipment|null $sort Sort Shipment results by a particular resource field. (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentParametersStatus|null $status Filter by Shipment status. This filter will return only Shipments with the specified status. (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefShipmentTransactionStatus|null $transaction_status transaction_status (optional)
     ...
     * @throws \MyParcelNL\Sdk\CoreApi\Generated\Shipments\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentResponsesShipments|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserError|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesSystemError
     */
     ...
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefTypesCarrier|null $carrier_id (optional)
     * @param  \DateTime|null $created When set, only resources created after this date will be returned. Inclusive. (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonParametersBoolean|null $delayed Filter on whether the current event code means the shipment has been delayed. (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonParametersFilterValidateBool|null $delivered (optional)
     * @param  bool|null $dropoff_today Use this parameter to only show Shipments that need to be dropped off today. (optional)
     * @param  bool|null $filter_hidden_shops (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonParametersFilterValidateBool|null $hidden (optional)
     ...
     * @param  string|null $reference_identifier Filter by &#x60;reference_identifier&#x60;, an optional arbitrary identifier to identify the Shipment. (optional)
     * @param  string|null $region The region, department, state or province of the address. (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentParametersShipmentType|null $shipment_type (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonParametersIds|null $shop_id (optional)
     * @param  int|null $size Specify the number of resources returned per page, used for paginated results. (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentParametersSortShipment|null $sort Sort Shipment results by a particular resource field. (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentParametersStatus|null $status Filter by Shipment status. This filter will return only Shipments with the specified status. (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefShipmentTransactionStatus|null $transaction_status (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getShipments'] to see the possible values for this operation
     *
     * @throws \MyParcelNL\Sdk\CoreApi\Generated\Shipments\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentResponsesShipments|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserError|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesSystemError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getShipmentsWithHttpInfo($user_agent, $barcode = null, $carrier_id = null, $created = null, $delayed = null, $delivered = null, $dropoff_today = null, $filter_hidden_shops = null, $hidden = null, $link_consumer_portal = null, $order = null, $package_type = null, $page = null, $q = null, $reference_identifier = null, $region = null, $shipment_type = null, $shop_id = null, $size = null, $sort = null, $status = null, $transaction_status = null, string $contentType = self::contentTypes['getShipments'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentResponsesShipments' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentResponsesShipments' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentResponsesShipments', []),
            ...
            $returnType = '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentResponsesShipments';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentResponsesShipments',
    ...
    public function getShipmentsRequest($user_agent, $barcode = null, $carrier_id = null, $created = null, $delayed = null, $delivered = null, $dropoff_today = null, $filter_hidden_shops = null, $hidden = null, $link_consumer_portal = null, $order = null, $package_type = null, $page = null, $q = null, $reference_identifier = null, $region = null, $shipment_type = null, $shop_id = null, $size = null, $sort = null, $status = null, $transaction_status = null, string $contentType = self::contentTypes['getShipments'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentDefsShipmentStatus|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentDefsShipmentStatus[]|string', // openApiType
            'form', // style
            true, // explode
            false // required
        ) ?? []);
     ...
     *
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CapabilitiesPostCapabilitiesRequestV2 $capabilities_post_capabilities_request_v2 Request body for capabilities endpoint. (required)
     ...
     * @throws \MyParcelNL\Sdk\CoreApi\Generated\Shipments\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CapabilitiesResponsesCapabilitiesV2|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserErrorInvalidContentType|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserError|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesSystemError
     */
    ...
    public function postCapabilitiesWithHttpInfo($capabilities_post_capabilities_request_v2, string $contentType = self::contentTypes['postCapabilities'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CapabilitiesResponsesCapabilitiesV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CapabilitiesResponsesCapabilitiesV2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CapabilitiesResponsesCapabilitiesV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 415:
                    if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserErrorInvalidContentType' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserErrorInvalidContentType' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserErrorInvalidContentType', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CapabilitiesResponsesCapabilitiesV2';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CapabilitiesResponsesCapabilitiesV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 415:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserErrorInvalidContentType',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $user_agent To give us insight into where requests come from and API documentation usage, you should send a &#x60;User-Agent&#x60; header with all your requests. This header should include information about your integration, the CMS/platform and the backend you are using. (required)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CapabilitiesPostContractDefinitionsRequestV2 $capabilities_post_contract_definitions_request_v2 Request body for capabilities contract definitions endpoint. (required)
     ...
     * @throws \MyParcelNL\Sdk\CoreApi\Generated\Shipments\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CapabilitiesResponsesContractDefinitionsV2|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserErrorInvalidContentType|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserError|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesSystemError
     */
    ...
    public function postCapabilitiesContractDefinitionsWithHttpInfo($user_agent, $capabilities_post_contract_definitions_request_v2, string $contentType = self::contentTypes['postCapabilitiesContractDefinitions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CapabilitiesResponsesContractDefinitionsV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CapabilitiesResponsesContractDefinitionsV2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CapabilitiesResponsesContractDefinitionsV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 415:
            ...
            $returnType = '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CapabilitiesResponsesContractDefinitionsV2';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CapabilitiesResponsesContractDefinitionsV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $user_agent To give us insight into where requests come from and API documentation usage, you should send a &#x60;User-Agent&#x60; header with all your requests. This header should include information about your integration, the CMS/platform and the backend you are using. (required)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RatesPostRatesRequestV2 $rates_post_rates_request_v2 Request body for rates endpoint. (required)
     ...
     * @throws \MyParcelNL\Sdk\CoreApi\Generated\Shipments\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefRatesResponseRateV2|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserErrorInvalidContentType|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserError|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesSystemError
     */
    ...
    public function postRatesWithHttpInfo($user_agent, $rates_post_rates_request_v2, string $contentType = self::contentTypes['postRates'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefRatesResponseRateV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefRatesResponseRateV2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefRatesResponseRateV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 415:
            ...
            $returnType = '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefRatesResponseRateV2';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefRatesResponseRateV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $user_agent To give us insight into where requests come from and API documentation usage, you should send a &#x60;User-Agent&#x60; header with all your requests. This header should include information about your integration, the CMS/platform and the backend you are using. (required)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentPostShipmentsRequestV11 $shipment_post_shipments_request_v11 Array of Shipment objects. (required)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentParametersPaperSize|null $format The size of a paper as specified in ISO216. (optional)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentParametersLabelPosition|null $positions The position of the label on an A4 sheet. You can specify multiple positions by semicolon separating them on the URI. Positioning is only applied on the first page with labels. All subsequent pages will use the default positioning 1,2,3,4. (optional)
     ...
     * @throws \MyParcelNL\Sdk\CoreApi\Generated\Shipments\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\InlineObject|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserErrorInvalidContentType|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserError|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesSystemError
     */
    ...
    public function postShipmentsWithHttpInfo($user_agent, $shipment_post_shipments_request_v11, $format = null, $positions = null, string $contentType = self::contentTypes['postShipments'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\InlineObject' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\InlineObject' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\InlineObject', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 415:
            ...
            $returnType = '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\InlineObject';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\InlineObject',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \MyParcelNL\Sdk\CoreApi\Generated\Shipments\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesDownloadUrl|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserErrorNotFound|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserError|\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesSystemError
     */
    ...
    public function postUnrelatedReturnShipmentsWithHttpInfo(string $contentType = self::contentTypes['postUnrelatedReturnShipments'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesDownloadUrl' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesDownloadUrl' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesDownloadUrl', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
                    if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserErrorNotFound' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserErrorNotFound' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserErrorNotFound', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesDownloadUrl';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesDownloadUrl',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\CommonResponsesUserErrorNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $user_agent To give us insight into where requests come from and API documentation usage, you should send a &#x60;User-Agent&#x60; header with all your requests. This header should include information about your integration, the CMS/platform and the backend you are using. (required)
     * @param  \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\ShipmentPutShipmentsRequestV11 $shipment_put_shipments_request_v11 Array of Shipment objects. (required)
