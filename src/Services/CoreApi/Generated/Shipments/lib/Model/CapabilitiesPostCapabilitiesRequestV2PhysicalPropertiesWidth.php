...
/**
 * CapabilitiesPostCapabilitiesRequestV2PhysicalPropertiesWidth Class Doc Comment
 *
 * @category Class
 ...
 */
class CapabilitiesPostCapabilitiesRequestV2PhysicalPropertiesWidth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'capabilities_post_capabilities_request_v2_physicalProperties_width';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value < 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling CapabilitiesPostCapabilitiesRequestV2PhysicalPropertiesWidth., must be bigger than or equal to 0.');
        }
