...
/**
 * CapabilitiesPostCapabilitiesRequestV2PhysicalPropertiesLength Class Doc Comment
 *
 * @category Class
 ...
 */
class CapabilitiesPostCapabilitiesRequestV2PhysicalPropertiesLength implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'capabilities_post_capabilities_request_v2_physicalProperties_length';
    ...
    */
     ...
     * Sets value
     *
     * @param float $value The length value
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if (($value < 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling CapabilitiesPostCapabilitiesRequestV2PhysicalPropertiesLength., must be bigger than or equal to 0.');
        }
