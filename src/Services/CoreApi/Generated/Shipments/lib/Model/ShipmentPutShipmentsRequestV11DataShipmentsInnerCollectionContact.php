    ...
    */
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling ShipmentPutShipmentsRequestV11DataShipmentsInnerCollectionContact., must be bigger than or equal to 1.');
        }
