...
/**
 * RefShipmentSender Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\CoreApi\Generated\Shipments
 * @author   OpenAPI Generator team
 ...
 */
class RefShipmentSender implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_ref_shipment_sender';
    ...
    protected static $openAPITypes = [
        ...
        'company' => 'string',
        'phone' => 'string',
        'email' => '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefShipmentSenderEmail'
    ];
    ...
    */
    ...
    public function setCc($cc)
    {
        ...
        if ((mb_strlen($cc) > 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling RefShipmentSender., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($cc) < 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling RefShipmentSender., must be bigger than or equal to 2.');
        }
    ...
    public function setBoxNumber($box_number)
    {
        ...
        if ((mb_strlen($box_number) > 8)) {
            throw new \InvalidArgumentException('invalid length for $box_number when calling RefShipmentSender., must be smaller than or equal to 8.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if ((mb_strlen($region) > 35)) {
            throw new \InvalidArgumentException('invalid length for $region when calling RefShipmentSender., must be smaller than or equal to 35.');
        }
     ...
     * Gets email
     *
     * @return \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefShipmentSenderEmail|null
     */
     ...
     * Sets email
     *
     * @param \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefShipmentSenderEmail|null $email email
     *
     * @return self
     */
