...
/**
 * SecondaryShipmentRequest Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\CoreApi\Generated\Shipments
 * @author   OpenAPI Generator team
 ...
 */
class SecondaryShipmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecondaryShipmentRequest';
    ...
    */
    ...
    public function setRecipients($recipients)
    {
        ...
        if ((count($recipients) < 1)) {
            throw new \InvalidArgumentException('invalid length for $recipients when calling SecondaryShipmentRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setShippedItems($shipped_items)
    {
        ...
        if ((count($shipped_items) < 0)) {
            throw new \InvalidArgumentException('invalid length for $shipped_items when calling SecondaryShipmentRequest., number of items must be greater than or equal to 0.');
        }
