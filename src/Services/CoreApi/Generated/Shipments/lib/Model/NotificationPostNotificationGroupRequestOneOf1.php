...
/**
 * NotificationPostNotificationGroupRequestOneOf1 Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\CoreApi\Generated\Shipments
 * @author   OpenAPI Generator team
 ...
 */
class NotificationPostNotificationGroupRequestOneOf1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'notification_post_notification_group_request_oneOf_1';
    ...
    */
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling NotificationPostNotificationGroupRequestOneOf1., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling NotificationPostNotificationGroupRequestOneOf1., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country_code)))) {
            throw new \InvalidArgumentException("invalid value for \$country_code when calling NotificationPostNotificationGroupRequestOneOf1., must conform to the pattern /^[A-Z]{2}$/.");
        }
