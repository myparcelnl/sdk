...
/**
 * CapabilitiesSender Class Doc Comment
 *
 * @category Class
 ...
 */
class CapabilitiesSender implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CapabilitiesSender';
    ...
    */
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling CapabilitiesSender., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling CapabilitiesSender., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country_code)))) {
            throw new \InvalidArgumentException("invalid value for \$country_code when calling CapabilitiesSender., must conform to the pattern /^[A-Z]{2}$/.");
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 15)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling CapabilitiesSender., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling CapabilitiesSender., must be bigger than or equal to 1.');
        }
