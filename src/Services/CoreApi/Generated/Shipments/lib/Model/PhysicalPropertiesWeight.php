...
class PhysicalPropertiesWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhysicalPropertiesWeight';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value < 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling PhysicalPropertiesWeight., must be bigger than or equal to 0.');
        }
