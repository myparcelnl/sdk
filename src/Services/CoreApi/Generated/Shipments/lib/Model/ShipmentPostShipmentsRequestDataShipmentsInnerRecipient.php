...
/**
 * ShipmentPostShipmentsRequestDataShipmentsInnerRecipient Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\CoreApi\Generated\Shipments
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentPostShipmentsRequestDataShipmentsInnerRecipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment_post_shipments_request_data_shipments_inner_recipient';
    ...
    */
    ...
    public function setCc($cc)
    {
        ...
        if ((mb_strlen($cc) > 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($cc) < 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be bigger than or equal to 2.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if ((mb_strlen($region) > 35)) {
            throw new \InvalidArgumentException('invalid length for $region when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 35.');
        }
    ...
    public function setState($state)
    {
        ...
        if ((mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 2.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 10.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 35)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be bigger than or equal to 1.');
        }
    ...
    public function setStreet($street)
    {
        ...
        if ((mb_strlen($street) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($street) < 1)) {
            throw new \InvalidArgumentException('invalid length for $street when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/\\D+/", ObjectSerializer::toString($street)))) {
            throw new \InvalidArgumentException("invalid value for \$street when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must conform to the pattern /\\D+/.");
        }
    ...
    public function setStreetAdditionalInfo($street_additional_info)
    {
        ...
        if ((mb_strlen($street_additional_info) > 50)) {
            throw new \InvalidArgumentException('invalid length for $street_additional_info when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 50.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 8)) {
            throw new \InvalidArgumentException('invalid length for $number when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 8.');
        }
    ...
    public function setNumberSuffix($number_suffix)
    {
        ...
        if ((mb_strlen($number_suffix) > 6)) {
            throw new \InvalidArgumentException('invalid length for $number_suffix when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 6.');
        }
    ...
    public function setBoxNumber($box_number)
    {
        ...
        if ((mb_strlen($box_number) > 8)) {
            throw new \InvalidArgumentException('invalid length for $box_number when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 8.');
        }
    ...
    public function setArea($area)
    {
        ...
        if ((mb_strlen($area) > 35)) {
            throw new \InvalidArgumentException('invalid length for $area when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 35.');
        }
    ...
    public function setPerson($person)
    {
        ...
        if ((mb_strlen($person) > 50)) {
            throw new \InvalidArgumentException('invalid length for $person when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($person) < 1)) {
            throw new \InvalidArgumentException('invalid length for $person when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be bigger than or equal to 1.');
        }
    ...
    public function setCompany($company)
    {
        ...
        if ((mb_strlen($company) > 50)) {
            throw new \InvalidArgumentException('invalid length for $company when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 50.');
        }
    ...
    public function setSecondaryEmails($secondary_emails)
    {
        ...
        if ((count($secondary_emails) > 4)) {
            throw new \InvalidArgumentException('invalid value for $secondary_emails when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., number of items must be less than or equal to 4.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 25)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling ShipmentPostShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 25.');
        }
