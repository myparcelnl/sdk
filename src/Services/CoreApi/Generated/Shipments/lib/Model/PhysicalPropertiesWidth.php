...
class PhysicalPropertiesWidth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhysicalPropertiesWidth';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value < 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling PhysicalPropertiesWidth., must be bigger than or equal to 0.');
        }
