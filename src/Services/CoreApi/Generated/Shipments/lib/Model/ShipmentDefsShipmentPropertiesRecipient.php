...
/**
 * ShipmentDefsShipmentPropertiesRecipient Class Doc Comment
 *
 * @category Class
 * @package  MyParcel\CoreApi\Generated\Shipments
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentDefsShipmentPropertiesRecipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment_defs_shipment_properties_recipient';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['person'] === null && !$this->isNullableSetToNull('person')) {
    ...
    public function setPerson($person)
    {
        ...
        if (!is_null($person) && (mb_strlen($person) > 50)) {
            throw new \InvalidArgumentException('invalid length for $person when calling ShipmentDefsShipmentPropertiesRecipient., must be smaller than or equal to 50.');
        }
        if (!is_null($person) && (mb_strlen($person) < 1)) {
            throw new \InvalidArgumentException('invalid length for $person when calling ShipmentDefsShipmentPropertiesRecipient., must be bigger than or equal to 1.');
        }
    ...
    public function setCompany($company)
    {
        ...
        if (!is_null($company) && (mb_strlen($company) > 50)) {
            throw new \InvalidArgumentException('invalid length for $company when calling ShipmentDefsShipmentPropertiesRecipient., must be smaller than or equal to 50.');
        }
    ...
    public function setStreet($street)
    {
        ...
        if (!is_null($street) && (mb_strlen($street) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street when calling ShipmentDefsShipmentPropertiesRecipient., must be smaller than or equal to 40.');
        }
        if (!is_null($street) && (mb_strlen($street) < 1)) {
            throw new \InvalidArgumentException('invalid length for $street when calling ShipmentDefsShipmentPropertiesRecipient., must be bigger than or equal to 1.');
        }
        if (!is_null($street) && (!preg_match("\D+", ObjectSerializer::toString($street)))) {
            throw new \InvalidArgumentException("invalid value for \$street when calling ShipmentDefsShipmentPropertiesRecipient., must conform to the pattern \D+.");
        }
    ...
    public function setStreetAdditionalInfo($street_additional_info)
    {
        ...
        if (!is_null($street_additional_info) && (mb_strlen($street_additional_info) > 50)) {
            throw new \InvalidArgumentException('invalid length for $street_additional_info when calling ShipmentDefsShipmentPropertiesRecipient., must be smaller than or equal to 50.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if (!is_null($number) && (mb_strlen($number) > 8)) {
            throw new \InvalidArgumentException('invalid length for $number when calling ShipmentDefsShipmentPropertiesRecipient., must be smaller than or equal to 8.');
        }
    ...
    public function setNumberSuffix($number_suffix)
    {
        ...
        if (!is_null($number_suffix) && (mb_strlen($number_suffix) > 6)) {
            throw new \InvalidArgumentException('invalid length for $number_suffix when calling ShipmentDefsShipmentPropertiesRecipient., must be smaller than or equal to 6.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling ShipmentDefsShipmentPropertiesRecipient., must be smaller than or equal to 10.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) > 35)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ShipmentDefsShipmentPropertiesRecipient., must be smaller than or equal to 35.');
        }
        if (!is_null($city) && (mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ShipmentDefsShipmentPropertiesRecipient., must be bigger than or equal to 1.');
        }
    ...
    public function setState($state)
    {
        ...
        if (!is_null($state) && (mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling ShipmentDefsShipmentPropertiesRecipient., must be smaller than or equal to 2.');
        }
    ...
    public function setCc($cc)
    {
        ...
        if ((mb_strlen($cc) > 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling ShipmentDefsShipmentPropertiesRecipient., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($cc) < 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling ShipmentDefsShipmentPropertiesRecipient., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[A-Za-z]{2}$/", ObjectSerializer::toString($cc)))) {
            throw new \InvalidArgumentException("invalid value for \$cc when calling ShipmentDefsShipmentPropertiesRecipient., must conform to the pattern /^[A-Za-z]{2}$/.");
        }
    ...
    public function setRegion($region)
    {
        ...
        if ((mb_strlen($region) > 35)) {
            throw new \InvalidArgumentException('invalid length for $region when calling ShipmentDefsShipmentPropertiesRecipient., must be smaller than or equal to 35.');
        }
    ...
    public function setArea($area)
    {
        ...
        if (!is_null($area) && (mb_strlen($area) > 35)) {
            throw new \InvalidArgumentException('invalid length for $area when calling ShipmentDefsShipmentPropertiesRecipient., must be smaller than or equal to 35.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (mb_strlen($phone) > 25)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling ShipmentDefsShipmentPropertiesRecipient., must be smaller than or equal to 25.');
        }
    ...
    public function setBoxNumber($box_number)
    {
        ...
        if ((mb_strlen($box_number) > 8)) {
            throw new \InvalidArgumentException('invalid length for $box_number when calling ShipmentDefsShipmentPropertiesRecipient., must be smaller than or equal to 8.');
        }
