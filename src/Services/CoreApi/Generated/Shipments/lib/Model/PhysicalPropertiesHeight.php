...
class PhysicalPropertiesHeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhysicalPropertiesHeight';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value < 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling PhysicalPropertiesHeight., must be bigger than or equal to 0.');
        }
