...
/**
 * ShipmentPutShipmentsRequestDataShipmentsInnerRecipient Class Doc Comment
 *
 * @category Class
 * @package  MyParcel\CoreApi\Generated\Shipments
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentPutShipmentsRequestDataShipmentsInnerRecipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment_put_shipments_request_data_shipments_inner_recipient';
    ...
    */
    ...
    public function setCc($cc)
    {
        ...
        if ((mb_strlen($cc) > 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling ShipmentPutShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($cc) < 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling ShipmentPutShipmentsRequestDataShipmentsInnerRecipient., must be bigger than or equal to 2.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if ((mb_strlen($region) > 32)) {
            throw new \InvalidArgumentException('invalid length for $region when calling ShipmentPutShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 32.');
        }
    ...
    public function setState($state)
    {
        ...
        if ((mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling ShipmentPutShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 2.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling ShipmentPutShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 10.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 35)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ShipmentPutShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 35.');
        }
    ...
    public function setStreet($street)
    {
        ...
        if ((mb_strlen($street) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street when calling ShipmentPutShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 40.');
        }
    ...
    public function setStreetAdditionalInfo($street_additional_info)
    {
        ...
        if ((mb_strlen($street_additional_info) > 50)) {
            throw new \InvalidArgumentException('invalid length for $street_additional_info when calling ShipmentPutShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 50.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if (!is_null($number) && (mb_strlen($number) > 8)) {
            throw new \InvalidArgumentException('invalid length for $number when calling ShipmentPutShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 8.');
        }
    ...
    public function setNumberSuffix($number_suffix)
    {
        ...
        if (!is_null($number_suffix) && (mb_strlen($number_suffix) > 6)) {
            throw new \InvalidArgumentException('invalid length for $number_suffix when calling ShipmentPutShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 6.');
        }
    ...
    public function setBoxNumber($box_number)
    {
        ...
        if ((mb_strlen($box_number) > 8)) {
            throw new \InvalidArgumentException('invalid length for $box_number when calling ShipmentPutShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 8.');
        }
    ...
    public function setPerson($person)
    {
        ...
        if ((mb_strlen($person) > 50)) {
            throw new \InvalidArgumentException('invalid length for $person when calling ShipmentPutShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 50.');
        }
    ...
    public function setCompany($company)
    {
        ...
        if ((mb_strlen($company) > 50)) {
            throw new \InvalidArgumentException('invalid length for $company when calling ShipmentPutShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 50.');
        }
    ...
    public function setSecondaryEmails($secondary_emails)
    {
        ...
        if ((count($secondary_emails) > 4)) {
            throw new \InvalidArgumentException('invalid value for $secondary_emails when calling ShipmentPutShipmentsRequestDataShipmentsInnerRecipient., number of items must be less than or equal to 4.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 25)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling ShipmentPutShipmentsRequestDataShipmentsInnerRecipient., must be smaller than or equal to 25.');
        }
