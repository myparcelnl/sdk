<?php
/**
 * ShipmentDefsShipmentPartnerTracktracesInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ShipmentDefsShipmentPartnerTracktracesInner Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\CoreApi\Generated\Shipments
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentDefsShipmentPartnerTracktracesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment_defs_shipment_partner_tracktraces_inner';
     ...
     * @return string[]
     */
    public function getUriAllowableValues()
    {
        return [
            self::URI_EMPTY,
        ];
