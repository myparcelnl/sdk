...
/**
 * ShipmentPostShipmentsRequestV11DataShipmentsInnerCollectionContact Class Doc Comment
 *
 * @category Class
 * @package  MyParcel\CoreApi\Generated\Shipments
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentPostShipmentsRequestV11DataShipmentsInnerCollectionContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment_post_shipments_request_v1_1_data_shipments_inner_collection_contact';
    ...
    */
    ...
    public function setCc($cc)
    {
        ...
        if ((mb_strlen($cc) > 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling ShipmentPostShipmentsRequestV11DataShipmentsInnerCollectionContact., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($cc) < 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling ShipmentPostShipmentsRequestV11DataShipmentsInnerCollectionContact., must be bigger than or equal to 2.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 255)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ShipmentPostShipmentsRequestV11DataShipmentsInnerCollectionContact., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ShipmentPostShipmentsRequestV11DataShipmentsInnerCollectionContact., must be bigger than or equal to 1.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) < 8)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling ShipmentPostShipmentsRequestV11DataShipmentsInnerCollectionContact., must be bigger than or equal to 8.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling ShipmentPostShipmentsRequestV11DataShipmentsInnerCollectionContact., must be bigger than or equal to 1.');
        }
    ...
    public function setStreet($street)
    {
        ...
        if ((mb_strlen($street) < 1)) {
            throw new \InvalidArgumentException('invalid length for $street when calling ShipmentPostShipmentsRequestV11DataShipmentsInnerCollectionContact., must be bigger than or equal to 1.');
        }
