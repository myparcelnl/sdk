...
class RefShipmentPickup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'location_type' => '\MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefShipmentBpostBpostPugoType',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['cc']) && !preg_match("/^[A-Z]{2}/", $this->container['cc'])) {
            $invalidProperties[] = "invalid value for 'cc', must be conform to the pattern /^[A-Z]{2}/.";
        }
    ...
    public function setCc($cc)
    {
        ...
        if ((mb_strlen($cc) > 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling RefShipmentPickup., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($cc) < 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling RefShipmentPickup., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[A-Z]{2}/", ObjectSerializer::toString($cc)))) {
            throw new \InvalidArgumentException("invalid value for \$cc when calling RefShipmentPickup., must conform to the pattern /^[A-Z]{2}/.");
        }
     ...
     * Gets location_type
     *
     * @return \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefShipmentBpostBpostPugoType|null
     */
     ...
     * Sets location_type
     *
     * @param \MyParcelNL\Sdk\CoreApi\Generated\Shipments\Model\RefShipmentBpostBpostPugoType|null $location_type location_type
     *
     * @return self
     */
