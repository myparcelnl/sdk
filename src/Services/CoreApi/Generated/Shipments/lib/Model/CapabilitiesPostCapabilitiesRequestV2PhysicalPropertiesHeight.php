...
/**
 * CapabilitiesPostCapabilitiesRequestV2PhysicalPropertiesHeight Class Doc Comment
 *
 * @category Class
 ...
 */
class CapabilitiesPostCapabilitiesRequestV2PhysicalPropertiesHeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'capabilities_post_capabilities_request_v2_physicalProperties_height';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value < 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling CapabilitiesPostCapabilitiesRequestV2PhysicalPropertiesHeight., must be bigger than or equal to 0.');
        }
