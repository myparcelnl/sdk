...
namespace MyParcelNL\Sdk\CoreApi\Generated\Shipments;
...
class Configuration
{
    ...
    {
        $report  = 'PHP SDK (MyParcelNL\Sdk\CoreApi\Generated\Shipments) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2025-02-13' . PHP_EOL;
