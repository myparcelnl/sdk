    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling RefTypesMoney., must conform to the pattern /^[A-Z]{3}$/.");
        }
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling RefTypesMoney., must be bigger than or equal to 0.');
        }
