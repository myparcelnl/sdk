<?php
/**
 * CommonHttpStatusCode5xxServerError505HttpVersionNotSupported
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CommonHttpStatusCode5xxServerError505HttpVersionNotSupported Class Doc Comment
 *
 * @category Class
 * @description The server does not support the HTTP protocol version that was used in the request message.
 * @package  MyParcel\CoreApi\Generated\Capabilities
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CommonHttpStatusCode5xxServerError505HttpVersionNotSupported
{
    /**
