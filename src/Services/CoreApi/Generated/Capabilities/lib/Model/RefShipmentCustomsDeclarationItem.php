...
class RefShipmentCustomsDeclarationItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'amount' => 'int',
        'weight' => 'int',
        'item_value' => '\MyParcel\CoreApi\Generated\Capabilities\Model\RefTypesMoney',
    ...
    */
     ...
     * Gets item_value
     *
     * @return \MyParcel\CoreApi\Generated\Capabilities\Model\RefTypesMoney
     */
     ...
     * Sets item_value
     *
     * @param \MyParcel\CoreApi\Generated\Capabilities\Model\RefTypesMoney $item_value item_value
     *
     * @return self
     */
    ...
    public function setCountry($country)
    {
        ...
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country)))) {
            throw new \InvalidArgumentException("invalid value for \$country when calling RefShipmentCustomsDeclarationItem., must conform to the pattern /^[A-Z]{2}$/.");
        }
