...
/**
 * RefShipmentRecipient Class Doc Comment
 *
 * @category Class
 * @package  MyParcel\CoreApi\Generated\Capabilities
 * @author   OpenAPI Generator team
 ...
 */
class RefShipmentRecipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_ref_shipment_recipient';
    ...
    protected static $openAPITypes = [
        ...
        'company' => 'string',
        'phone' => 'string',
        'email' => '\MyParcel\CoreApi\Generated\Capabilities\Model\RefShipmentRecipientSecondaryEmailsInner',
    ...
    */
    ...
    public function setCc($cc)
    {
        ...
        if ((mb_strlen($cc) > 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling RefShipmentRecipient., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($cc) < 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling RefShipmentRecipient., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[A-Za-z]{2}$/", ObjectSerializer::toString($cc)))) {
            throw new \InvalidArgumentException("invalid value for \$cc when calling RefShipmentRecipient., must conform to the pattern /^[A-Za-z]{2}$/.");
        }
    ...
    public function setRegion($region)
    {
        ...
        if ((mb_strlen($region) > 35)) {
            throw new \InvalidArgumentException('invalid length for $region when calling RefShipmentRecipient., must be smaller than or equal to 35.');
        }
    ...
    public function setState($state)
    {
        ...
        if ((mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling RefShipmentRecipient., must be smaller than or equal to 2.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling RefShipmentRecipient., must be smaller than or equal to 10.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 35)) {
            throw new \InvalidArgumentException('invalid length for $city when calling RefShipmentRecipient., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling RefShipmentRecipient., must be bigger than or equal to 1.');
        }
    ...
    public function setStreet($street)
    {
        ...
        if ((mb_strlen($street) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street when calling RefShipmentRecipient., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($street) < 1)) {
            throw new \InvalidArgumentException('invalid length for $street when calling RefShipmentRecipient., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/\\\\D+/", ObjectSerializer::toString($street)))) {
            throw new \InvalidArgumentException("invalid value for \$street when calling RefShipmentRecipient., must conform to the pattern /\\\\D+/.");
        }
    ...
    public function setStreetAdditionalInfo($street_additional_info)
    {
        ...
        if ((mb_strlen($street_additional_info) > 50)) {
            throw new \InvalidArgumentException('invalid length for $street_additional_info when calling RefShipmentRecipient., must be smaller than or equal to 50.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 8)) {
            throw new \InvalidArgumentException('invalid length for $number when calling RefShipmentRecipient., must be smaller than or equal to 8.');
        }
    ...
    public function setNumberSuffix($number_suffix)
    {
        ...
        if ((mb_strlen($number_suffix) > 6)) {
            throw new \InvalidArgumentException('invalid length for $number_suffix when calling RefShipmentRecipient., must be smaller than or equal to 6.');
        }
    ...
    public function setBoxNumber($box_number)
    {
        ...
        if ((mb_strlen($box_number) > 8)) {
            throw new \InvalidArgumentException('invalid length for $box_number when calling RefShipmentRecipient., must be smaller than or equal to 8.');
        }
    ...
    public function setArea($area)
    {
        ...
        if ((mb_strlen($area) > 35)) {
            throw new \InvalidArgumentException('invalid length for $area when calling RefShipmentRecipient., must be smaller than or equal to 35.');
        }
    ...
    public function setPerson($person)
    {
        ...
        if ((mb_strlen($person) > 50)) {
            throw new \InvalidArgumentException('invalid length for $person when calling RefShipmentRecipient., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($person) < 1)) {
            throw new \InvalidArgumentException('invalid length for $person when calling RefShipmentRecipient., must be bigger than or equal to 1.');
        }
    ...
    public function setCompany($company)
    {
        ...
        if ((mb_strlen($company) > 50)) {
            throw new \InvalidArgumentException('invalid length for $company when calling RefShipmentRecipient., must be smaller than or equal to 50.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 25)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling RefShipmentRecipient., must be smaller than or equal to 25.');
        }
     ...
     * Sets email
     *
     * @param \MyParcel\CoreApi\Generated\Capabilities\Model\RefShipmentRecipientSecondaryEmailsInner|null $email email
     *
     * @return self
     */
    ...
    public function setSecondaryEmails($secondary_emails)
    {
        ...
        if ((count($secondary_emails) > 4)) {
            throw new \InvalidArgumentException('invalid value for $secondary_emails when calling RefShipmentRecipient., number of items must be less than or equal to 4.');
        }
