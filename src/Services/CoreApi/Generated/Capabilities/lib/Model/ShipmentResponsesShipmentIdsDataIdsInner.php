...
/**
 * ShipmentResponsesShipmentIdsDataIdsInner Class Doc Comment
 *
 * @category Class
 * @package  MyParcel\CoreApi\Generated\Capabilities
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentResponsesShipmentIdsDataIdsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment_responses_shipment_ids_data_ids_inner';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'reference_identifier' => '\MyParcel\CoreApi\Generated\Capabilities\Model\RefShipmentReferenceIdentifier'
    ];
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ShipmentResponsesShipmentIdsDataIdsInner., must be smaller than or equal to 9223372036854775807.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ShipmentResponsesShipmentIdsDataIdsInner., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \MyParcel\CoreApi\Generated\Capabilities\Model\RefShipmentReferenceIdentifier
     */
     ...
     *
     * @param \MyParcel\CoreApi\Generated\Capabilities\Model\RefShipmentReferenceIdentifier $reference_identifier reference_identifier
     *
     * @return self
     */
