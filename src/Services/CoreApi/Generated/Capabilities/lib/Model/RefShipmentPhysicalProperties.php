...
/**
 * RefShipmentPhysicalProperties Class Doc Comment
 *
 * @category Class
 * @package  MyParcel\CoreApi\Generated\Capabilities
 * @author   OpenAPI Generator team
 ...
 */
class RefShipmentPhysicalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_ref_shipment_physical_properties';
    ...
    */
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight > 999999999)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling RefShipmentPhysicalProperties., must be smaller than or equal to 999999999.');
        }
        if (($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling RefShipmentPhysicalProperties., must be bigger than or equal to 0.');
        }
