...
require_once('Adapter/DeliveryOptions/DeliveryOptions.php');
require_once('Adapter/DeliveryOptions/PickupLocation.php');
require_once('Adapter/DeliveryOptions/ShipmentOptions.php');
