...
require_once('Model/DeliveryOptions/DeliveryOptions.php');
require_once('Model/DeliveryOptions/PickupLocation.php');
require_once('Model/DeliveryOptions/ShipmentOptions.php');
