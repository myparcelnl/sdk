# MyParcelNL\Sdk\Client\Generated\CoreApi
...
```php
<?php
require_once('/path/to/MyParcelNL\Sdk\Client\Generated\CoreApi/vendor/autoload.php');
```
...
- [BillingDefsShipmentDataInner](docs/Model/BillingDefsShipmentDataInner.md)
...
- [CapabilitiesPostCapabilitiesRequestV2OptionsInsurance](docs/Model/CapabilitiesPostCapabilitiesRequestV2OptionsInsurance.md)
...
- [CommonDefsDayOfWeek](docs/Model/CommonDefsDayOfWeek.md)
- [CommonDefsDownloadUrl](docs/Model/CommonDefsDownloadUrl.md)
- [CommonDefsIsoDayOfWeek](docs/Model/CommonDefsIsoDayOfWeek.md)
...
- [CommonHttpStatusCode4xxClientError400BadRequest](docs/Model/CommonHttpStatusCode4xxClientError400BadRequest.md)
- [CommonHttpStatusCode4xxClientError401Unauthorized](docs/Model/CommonHttpStatusCode4xxClientError401Unauthorized.md)
...
- [CommonResponsesDownloadLink](docs/Model/CommonResponsesDownloadLink.md)
- [CommonResponsesDownloadLinkData](docs/Model/CommonResponsesDownloadLinkData.md)
- [CommonResponsesDownloadLinkDataOneOf](docs/Model/CommonResponsesDownloadLinkDataOneOf.md)
- [CommonResponsesDownloadLinkDataOneOf1](docs/Model/CommonResponsesDownloadLinkDataOneOf1.md)
- [CommonResponsesDownloadLinkDataOneOf2](docs/Model/CommonResponsesDownloadLinkDataOneOf2.md)
- [CommonResponsesDownloadLinkDataOneOf3](docs/Model/CommonResponsesDownloadLinkDataOneOf3.md)
- [CommonResponsesDownloadLinkDataOneOf4](docs/Model/CommonResponsesDownloadLinkDataOneOf4.md)
- [CommonResponsesDownloadLinkDefinitionsUrl](docs/Model/CommonResponsesDownloadLinkDefinitionsUrl.md)
...
- [CommonResponsesProblem](docs/Model/CommonResponsesProblem.md)
- [CommonResponsesProblemErrorsInner](docs/Model/CommonResponsesProblemErrorsInner.md)
...
- [CommonResponsesUserErrorBadRequest](docs/Model/CommonResponsesUserErrorBadRequest.md)
- [CommonResponsesUserErrorBadRequestAllOfErrors](docs/Model/CommonResponsesUserErrorBadRequestAllOfErrors.md)
...
- [CommonResponsesUserErrorNotAcceptable](docs/Model/CommonResponsesUserErrorNotAcceptable.md)
- [CommonResponsesUserErrorNotAcceptableAllOfErrors](docs/Model/CommonResponsesUserErrorNotAcceptableAllOfErrors.md)
...
- [PostShipmentsFormatParameter](docs/Model/PostShipmentsFormatParameter.md)
...
- [RatesPostRatesRequestV1DataRatesInnerOptionsInsuranceOneOf](docs/Model/RatesPostRatesRequestV1DataRatesInnerOptionsInsuranceOneOf.md)
...
- [RatesPostRatesRequestV2OptionsInsuranceOneOf](docs/Model/RatesPostRatesRequestV2OptionsInsuranceOneOf.md)
- [RatesPostRatesRequestV2OptionsRequiresCashOnDelivery](docs/Model/RatesPostRatesRequestV2OptionsRequiresCashOnDelivery.md)
- [RatesPostRatesRequestV2PhysicalProperties](docs/Model/RatesPostRatesRequestV2PhysicalProperties.md)
- [RatesPostRatesRequestV2PhysicalPropertiesHeight](docs/Model/RatesPostRatesRequestV2PhysicalPropertiesHeight.md)
- [RatesPostRatesRequestV2PhysicalPropertiesLength](docs/Model/RatesPostRatesRequestV2PhysicalPropertiesLength.md)
- [RatesPostRatesRequestV2PhysicalPropertiesWidth](docs/Model/RatesPostRatesRequestV2PhysicalPropertiesWidth.md)
...
- [RefCapabilitiesResponsePhysicalPropertiesPhysicalPropertiesV1](docs/Model/RefCapabilitiesResponsePhysicalPropertiesPhysicalPropertiesV1.md)
- [RefCapabilitiesResponsePhysicalPropertiesPhysicalPropertiesV2](docs/Model/RefCapabilitiesResponsePhysicalPropertiesPhysicalPropertiesV2.md)
...
- [RefCapabilitiesSharedContractV1](docs/Model/RefCapabilitiesSharedContractV1.md)
- [RefCapabilitiesSharedContractV2](docs/Model/RefCapabilitiesSharedContractV2.md)
...
- [RefShipmentLocationType](docs/Model/RefShipmentLocationType.md)
- [RefShipmentLocationTypeV2](docs/Model/RefShipmentLocationTypeV2.md)
...
- [RefShipmentPickupLocationType](docs/Model/RefShipmentPickupLocationType.md)
...
- [RefShipmentShipmentTypeV2](docs/Model/RefShipmentShipmentTypeV2.md)
...
- [RefTypesMoneyNullableAmount](docs/Model/RefTypesMoneyNullableAmount.md)
- [RefTypesMoneyPropertiesAmount](docs/Model/RefTypesMoneyPropertiesAmount.md)
- [RefTypesMoneyPropertiesCurrency](docs/Model/RefTypesMoneyPropertiesCurrency.md)
- [RefTypesPriceEuro](docs/Model/RefTypesPriceEuro.md)
- [RefTypesShipmentType](docs/Model/RefTypesShipmentType.md)
...
- [ShipmentDefsOccupancy](docs/Model/ShipmentDefsOccupancy.md)
...
- [ShipmentDefsShipmentPhysicalPropertiesCarrierWeight](docs/Model/ShipmentDefsShipmentPhysicalPropertiesCarrierWeight.md)
- [ShipmentDefsShipmentPickupLocationType](docs/Model/ShipmentDefsShipmentPickupLocationType.md)
...
- [ShipmentResponsesDropOffPoint](docs/Model/ShipmentResponsesDropOffPoint.md)
- [ShipmentResponsesDropOffPointDefinitionsAvailableDaysInner](docs/Model/ShipmentResponsesDropOffPointDefinitionsAvailableDaysInner.md)
- [ShipmentResponsesDropOffPointDefinitionsOpeningHours](docs/Model/ShipmentResponsesDropOffPointDefinitionsOpeningHours.md)
- [ShipmentResponsesDropOffPointDefinitionsTimeframe](docs/Model/ShipmentResponsesDropOffPointDefinitionsTimeframe.md)
- [ShipmentResponsesDropOffPointNumber](docs/Model/ShipmentResponsesDropOffPointNumber.md)
- [ShipmentResponsesDropOffPoints](docs/Model/ShipmentResponsesDropOffPoints.md)
- [ShipmentResponsesDropOffPointsData](docs/Model/ShipmentResponsesDropOffPointsData.md)
...
- [ShipmentResponsesPostShipmentsV12](docs/Model/ShipmentResponsesPostShipmentsV12.md)
- [ShipmentResponsesPostShipmentsV12Data](docs/Model/ShipmentResponsesPostShipmentsV12Data.md)
- [ShipmentResponsesPostShipmentsV12DataPdf](docs/Model/ShipmentResponsesPostShipmentsV12DataPdf.md)
- [ShipmentResponsesPostShipmentsV12DataZpl](docs/Model/ShipmentResponsesPostShipmentsV12DataZpl.md)
- [ShipmentResponsesPutShipmentsV12](docs/Model/ShipmentResponsesPutShipmentsV12.md)
- [ShipmentResponsesPutShipmentsV12Data](docs/Model/ShipmentResponsesPutShipmentsV12Data.md)
