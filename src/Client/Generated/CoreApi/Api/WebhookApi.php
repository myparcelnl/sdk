...
class WebhookApi
{
    ...
    {
        list($response) = $this->getWebhookSubscriptionsWithHttpInfo($hook, $user_agent, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getWebhookSubscriptionsRequest($hook, $user_agent, $contentType);
    ...
    {
        return $this->getWebhookSubscriptionsAsyncWithHttpInfo($hook, $user_agent, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        list($response) = $this->postWebhookSubscriptionsWithHttpInfo($webhooks_post_webhook_subscriptions_request_v11, $user_agent, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->postWebhookSubscriptionsRequest($webhooks_post_webhook_subscriptions_request_v11, $user_agent, $contentType);
    ...
    {
        return $this->postWebhookSubscriptionsAsyncWithHttpInfo($webhooks_post_webhook_subscriptions_request_v11, $user_agent, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
