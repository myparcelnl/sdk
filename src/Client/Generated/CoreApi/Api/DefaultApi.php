...
class DefaultApi
{
    ...
    public function getIndexWithHttpInfo($user_agent = null, string $contentType = self::contentTypes['getIndex'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyParcelNL\Sdk\Client\Generated\CoreApi\Model\GetIndex200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyParcelNL\Sdk\Client\Generated\CoreApi\Model\GetIndex200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyParcelNL\Sdk\Client\Generated\CoreApi\Model\GetIndex200Response', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyParcelNL\Sdk\Client\Generated\CoreApi\Model\GetIndex200Response',
