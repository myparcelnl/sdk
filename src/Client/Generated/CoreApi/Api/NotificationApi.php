...
class NotificationApi
{
    ...
    {
        list($response) = $this->getNotificationGroupsWithHttpInfo($shop_id, $user_agent, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getNotificationGroupsRequest($shop_id, $user_agent, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyParcelNL\Sdk\Client\Generated\CoreApi\Model\NotificationResponsesNotificationGroups' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyParcelNL\Sdk\Client\Generated\CoreApi\Model\NotificationResponsesNotificationGroups' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyParcelNL\Sdk\Client\Generated\CoreApi\Model\NotificationResponsesNotificationGroups', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyParcelNL\Sdk\Client\Generated\CoreApi\Model\NotificationResponsesNotificationGroups',
    ...
    {
        return $this->getNotificationGroupsAsyncWithHttpInfo($shop_id, $user_agent, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function getNotificationTemplatesWithHttpInfo($notification_group_id, $user_agent = null, string $contentType = self::contentTypes['getNotificationTemplates'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyParcelNL\Sdk\Client\Generated\CoreApi\Model\NotificationResponsesNotificationTemplates' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyParcelNL\Sdk\Client\Generated\CoreApi\Model\NotificationResponsesNotificationTemplates' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyParcelNL\Sdk\Client\Generated\CoreApi\Model\NotificationResponsesNotificationTemplates', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyParcelNL\Sdk\Client\Generated\CoreApi\Model\NotificationResponsesNotificationTemplates',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        list($response) = $this->postNotificationGroupsWithHttpInfo($notification_post_notification_group_request, $user_agent, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->postNotificationGroupsRequest($notification_post_notification_group_request, $user_agent, $contentType);
    ...
    {
        return $this->postNotificationGroupsAsyncWithHttpInfo($notification_post_notification_group_request, $user_agent, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $this->putNotificationTemplateWithHttpInfo($notification_group_id, $notification_template_id, $notification_put_notification_template_request, $user_agent, $contentType);
    }
    ...
    {
        $request = $this->putNotificationTemplateRequest($notification_group_id, $notification_template_id, $notification_put_notification_template_request, $user_agent, $contentType);
    ...
    {
        return $this->putNotificationTemplateAsyncWithHttpInfo($notification_group_id, $notification_template_id, $notification_put_notification_template_request, $user_agent, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
