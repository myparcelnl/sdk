...
class ShipmentDefsShipmentRecipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'region' => 'string',
        'email' => 'string',
        'billing_email' => '\MyParcelNL\Sdk\Client\Generated\CoreApi\Model\AccountDefsContactPropertiesEmail',
    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling ShipmentDefsShipmentRecipient., must be smaller than or equal to 50.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling ShipmentDefsShipmentRecipient., must be smaller than or equal to 50.');
        }
     ...
     * Sets billing_email
     *
     * @param \MyParcelNL\Sdk\Client\Generated\CoreApi\Model\AccountDefsContactPropertiesEmail|null $billing_email billing_email
     *
     * @return self
     */
