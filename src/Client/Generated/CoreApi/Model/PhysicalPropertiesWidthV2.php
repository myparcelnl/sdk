...
/**
 * PhysicalPropertiesWidthV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class PhysicalPropertiesWidthV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhysicalPropertiesWidthV2';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value > 10000)) {
            throw new \InvalidArgumentException('invalid value for $value when calling PhysicalPropertiesWidthV2., must be smaller than or equal to 10000.');
        }
        if (($value < 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling PhysicalPropertiesWidthV2., must be bigger than or equal to 0.');
        }
