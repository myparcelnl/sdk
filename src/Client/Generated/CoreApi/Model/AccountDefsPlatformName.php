...
/**
 * AccountDefsPlatformName Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\CoreApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AccountDefsPlatformName
{
    /**
     * Possible values of this enum
     */
    public const MYPARCEL = 'myparcel';

    public const FLESPAKKET = 'flespakket';

    public const BELGIE = 'belgie';

    public const DELIVERY_DUTCH = 'delivery_dutch';

    public const POSTNL_CUSTOMER = 'postnl_customer';
