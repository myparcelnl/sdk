...
/**
 * RatesPostRatesRequestV2PhysicalPropertiesLength Class Doc Comment
 *
 * @category Class
 ...
 */
class RatesPostRatesRequestV2PhysicalPropertiesLength implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rates_post_rates_request_v2_physicalProperties_length';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value < 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling RatesPostRatesRequestV2PhysicalPropertiesLength., must be bigger than or equal to 0.');
        }
