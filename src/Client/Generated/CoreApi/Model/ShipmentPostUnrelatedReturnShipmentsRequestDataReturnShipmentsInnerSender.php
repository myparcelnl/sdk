...
/**
 * ShipmentPostUnrelatedReturnShipmentsRequestDataReturnShipmentsInnerSender Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\CoreApi
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentPostUnrelatedReturnShipmentsRequestDataReturnShipmentsInnerSender implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment_post_unrelated_return_shipments_request_data_return_shipments_inner_sender';
    ...
    protected static $openAPITypes = [
        ...
        'person' => 'string',
        'company' => 'string',
        'email' => '\MyParcelNL\Sdk\Client\Generated\CoreApi\Model\ShipmentPostReturnShipmentsRequestDataReturnShipmentsInnerSenderEmail',
        'phone' => 'string'
    ];
    ...
    */
    ...
    public function setCc($cc)
    {
        ...
        if ((mb_strlen($cc) > 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling ShipmentPostUnrelatedReturnShipmentsRequestDataReturnShipmentsInnerSender., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($cc) < 2)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling ShipmentPostUnrelatedReturnShipmentsRequestDataReturnShipmentsInnerSender., must be bigger than or equal to 2.');
        }
    ...
    public function setBoxNumber($box_number)
    {
        ...
        if ((mb_strlen($box_number) > 8)) {
            throw new \InvalidArgumentException('invalid length for $box_number when calling ShipmentPostUnrelatedReturnShipmentsRequestDataReturnShipmentsInnerSender., must be smaller than or equal to 8.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if ((mb_strlen($region) > 35)) {
            throw new \InvalidArgumentException('invalid length for $region when calling ShipmentPostUnrelatedReturnShipmentsRequestDataReturnShipmentsInnerSender., must be smaller than or equal to 35.');
        }
     ...
     * Gets email
     *
     * @return \MyParcelNL\Sdk\Client\Generated\CoreApi\Model\ShipmentPostReturnShipmentsRequestDataReturnShipmentsInnerSenderEmail|null
     */
     ...
     * Sets email
     *
     * @param \MyParcelNL\Sdk\Client\Generated\CoreApi\Model\ShipmentPostReturnShipmentsRequestDataReturnShipmentsInnerSenderEmail|null $email email
     *
     * @return self
     */
