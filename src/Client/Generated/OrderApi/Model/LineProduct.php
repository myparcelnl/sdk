...
/**
 * LineProduct Class Doc Comment
 *
 * @category Class
 * @description The product of an order line.
 * @package  MyParcelNL\Sdk\Client\Generated\OrderApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LineProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Line_product';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 250)) {
            throw new \InvalidArgumentException('invalid length for $name when calling LineProduct., must be smaller than or equal to 250.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling LineProduct., must be bigger than or equal to 1.');
        }
    ...
    public function setSku($sku)
    {
        ...
        if ((mb_strlen($sku) > 200)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling LineProduct., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling LineProduct., must be bigger than or equal to 1.');
        }
     ...
     * Sets id
     *
     * @param string|null $id Identifier of the product. This is always undefined when the `status` is `DISCOVERED` or `IMPORT_REQUESTED`, otherwise it is always defined.
     *
     * @return self
     */
