<?php
/**
 * PhysicalPropertiesWeightRequiredWeight
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PhysicalPropertiesWeightRequiredWeight Class Doc Comment
 *
 * @category Class
 ...
 */
class PhysicalPropertiesWeightRequiredWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhysicalPropertiesWeightRequired_weight';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value > 999999999)) {
            throw new \InvalidArgumentException('invalid value for $value when calling PhysicalPropertiesWeightRequiredWeight., must be smaller than or equal to 999999999.');
        }
        if (($value < 1)) {
            throw new \InvalidArgumentException('invalid value for $value when calling PhysicalPropertiesWeightRequiredWeight., must be bigger than or equal to 1.');
        }
