<?php
/**
 * OrderRulesSetShippingPreferencesPathInnerAnyOf1Condition
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * OrderRulesSetShippingPreferencesPathInnerAnyOf1Condition Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\OrderApi
 * @author   OpenAPI Generator team
 ...
 */
class OrderRulesSetShippingPreferencesPathInnerAnyOf1Condition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Order_rules_setShippingPreferences_path_inner_anyOf_1_condition';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('geo_area_code', $data ?? [], null);
    }
    ...
    */
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling OrderRulesSetShippingPreferencesPathInnerAnyOf1Condition., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling OrderRulesSetShippingPreferencesPathInnerAnyOf1Condition., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/[A-Z]{2}/", ObjectSerializer::toString($country_code)))) {
            throw new \InvalidArgumentException("invalid value for \$country_code when calling OrderRulesSetShippingPreferencesPathInnerAnyOf1Condition., must conform to the pattern /[A-Z]{2}/.");
        }
    ...
    {
        return $this->container['geo_area_code'];
    }
     ...
     * @return self
     */
    public function setGeoAreaCode($geo_area_code)
    {
