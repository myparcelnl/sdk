...
/**
 * EditNotePostRequestInner Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\OrderApi
 * @author   OpenAPI Generator team
 ...
 */
class EditNotePostRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_edit_note_post_request_inner';
    ...
    */
     ...
     * Sets note_id
     *
     * @param string $note_id The unique identifier of a note of an order.
     *
     * @return self
     */
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 2500)) {
            throw new \InvalidArgumentException('invalid length for $text when calling EditNotePostRequestInner., must be smaller than or equal to 2500.');
        }
        if ((mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling EditNotePostRequestInner., must be bigger than or equal to 1.');
        }
