...
/**
 * CustomsDeclarationResponseGroupsInner Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomsDeclarationResponseGroupsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomsDeclarationResponse_groups_inner';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 100)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CustomsDeclarationResponseGroupsInner., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CustomsDeclarationResponseGroupsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setHsCode($hs_code)
    {
        ...
        if ((mb_strlen($hs_code) > 12)) {
            throw new \InvalidArgumentException('invalid length for $hs_code when calling CustomsDeclarationResponseGroupsInner., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($hs_code) < 6)) {
            throw new \InvalidArgumentException('invalid length for $hs_code when calling CustomsDeclarationResponseGroupsInner., must be bigger than or equal to 6.');
        }
    ...
    public function setNumberOfItems($number_of_items)
    {
        ...
        if (($number_of_items > 99999)) {
            throw new \InvalidArgumentException('invalid value for $number_of_items when calling CustomsDeclarationResponseGroupsInner., must be smaller than or equal to 99999.');
        }
        if (($number_of_items < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_of_items when calling CustomsDeclarationResponseGroupsInner., must be bigger than or equal to 1.');
        }
     ...
     * Gets total_weight
     *
     * @return \MyParcelNL\Sdk\Client\Generated\OrderApi\Model\CustomsDeclarationResponseGroupsInnerTotalWeight
     */
     ...
     * Sets total_weight
     *
     * @param \MyParcelNL\Sdk\Client\Generated\OrderApi\Model\CustomsDeclarationResponseGroupsInnerTotalWeight $total_weight total_weight
     *
     * @return self
     */
