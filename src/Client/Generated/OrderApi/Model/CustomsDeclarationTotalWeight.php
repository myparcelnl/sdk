...
/**
 * CustomsDeclarationTotalWeight Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomsDeclarationTotalWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomsDeclaration_totalWeight';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value > 999999999)) {
            throw new \InvalidArgumentException('invalid value for $value when calling CustomsDeclarationTotalWeight., must be smaller than or equal to 999999999.');
        }
        if (($value < 1)) {
            throw new \InvalidArgumentException('invalid value for $value when calling CustomsDeclarationTotalWeight., must be bigger than or equal to 1.');
        }
