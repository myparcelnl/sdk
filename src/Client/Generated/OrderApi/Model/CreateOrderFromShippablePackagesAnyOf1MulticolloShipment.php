...
/**
 * CreateOrderFromShippablePackagesAnyOf1MulticolloShipment Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\OrderApi
 * @author   OpenAPI Generator team
 ...
 */
class CreateOrderFromShippablePackagesAnyOf1MulticolloShipment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateOrderFromShippablePackages_anyOf_1_multicollo_shipment';
    ...
    */
    ...
    public function setCustomContractId($custom_contract_id)
    {
        ...
        if ((mb_strlen($custom_contract_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $custom_contract_id when calling CreateOrderFromShippablePackagesAnyOf1MulticolloShipment., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($custom_contract_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $custom_contract_id when calling CreateOrderFromShippablePackagesAnyOf1MulticolloShipment., must be bigger than or equal to 1.');
        }
