 ...
 */
class AddPackages implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddPackages';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'packages' => '\MyParcelNL\Sdk\Client\Generated\OrderApi\Model\PackageRequest[]'
    ];
    ...
    */
     ...
     * Gets packages
     *
     * @return \MyParcelNL\Sdk\Client\Generated\OrderApi\Model\PackageRequest[]
     */
     ...
     * Sets packages
     *
     * @param \MyParcelNL\Sdk\Client\Generated\OrderApi\Model\PackageRequest[] $packages packages
     *
     * @return self
     */
    public function setPackages($packages)
    {
        ...
        if ((count($packages) > 25)) {
            throw new \InvalidArgumentException('invalid value for $packages when calling AddPackages., number of items must be less than or equal to 25.');
        }
        if ((count($packages) < 1)) {
            throw new \InvalidArgumentException('invalid length for $packages when calling AddPackages., number of items must be greater than or equal to 1.');
        }
