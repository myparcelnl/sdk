<?php
/**
 * PhysicalPropertiesWeightRequiredHeight
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PhysicalPropertiesWeightRequiredHeight Class Doc Comment
 *
 * @category Class
 ...
 */
class PhysicalPropertiesWeightRequiredHeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhysicalPropertiesWeightRequired_height';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value > 1000000)) {
            throw new \InvalidArgumentException('invalid value for $value when calling PhysicalPropertiesWeightRequiredHeight., must be smaller than or equal to 1000000.');
        }
        if (($value < 1)) {
            throw new \InvalidArgumentException('invalid value for $value when calling PhysicalPropertiesWeightRequiredHeight., must be bigger than or equal to 1.');
        }
