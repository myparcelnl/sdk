...
/**
 * CreateOrderFromShippablePackagesAnyOf1Multicollo Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\OrderApi
 * @author   OpenAPI Generator team
 ...
 */
class CreateOrderFromShippablePackagesAnyOf1Multicollo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateOrderFromShippablePackages_anyOf_1_multicollo';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['packages']) > 10)) {
            $invalidProperties[] = "invalid value for 'packages', number of items must be less than or equal to 10.";
        }
     ...
     * Gets packages
     *
     * @return \MyParcelNL\Sdk\Client\Generated\OrderApi\Model\PackageCommon[]
     */
     ...
     * Sets packages
     *
     * @param \MyParcelNL\Sdk\Client\Generated\OrderApi\Model\PackageCommon[] $packages packages
     *
     * @return self
     */
    public function setPackages($packages)
    {
        ...
        if ((count($packages) > 10)) {
            throw new \InvalidArgumentException('invalid value for $packages when calling CreateOrderFromShippablePackagesAnyOf1Multicollo., number of items must be less than or equal to 10.');
        }
        if ((count($packages) < 2)) {
            throw new \InvalidArgumentException('invalid length for $packages when calling CreateOrderFromShippablePackagesAnyOf1Multicollo., number of items must be greater than or equal to 2.');
        }
