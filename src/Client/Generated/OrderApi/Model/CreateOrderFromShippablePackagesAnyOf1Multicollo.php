    ...
    */
    ...
    public function setPackages($packages)
    {
        ...
        if ((count($packages) > 20)) {
            throw new \InvalidArgumentException('invalid value for $packages when calling CreateOrderFromShippablePackagesAnyOf1Multicollo., number of items must be less than or equal to 20.');
        }
        if ((count($packages) < 2)) {
