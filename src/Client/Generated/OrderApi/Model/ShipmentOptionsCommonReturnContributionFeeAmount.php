...
/**
 * ShipmentOptionsCommonReturnContributionFeeAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentOptionsCommonReturnContributionFeeAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentOptionsCommon_returnContributionFee_amount';
    ...
    */
     ...
     * Sets currency
     *
     * @param string $currency ISO 4217 three-letter currency code.
     *
     * @return self
     */
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ShipmentOptionsCommonReturnContributionFeeAmount., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ShipmentOptionsCommonReturnContributionFeeAmount., must be bigger than or equal to 3.');
        }
    ...
    public function setFractional($fractional)
    {
        ...
        if (($fractional < 0)) {
            throw new \InvalidArgumentException('invalid value for $fractional when calling ShipmentOptionsCommonReturnContributionFeeAmount., must be bigger than or equal to 0.');
        }
    ...
    public function setIntegral($integral)
    {
        ...
        if (($integral < 0)) {
            throw new \InvalidArgumentException('invalid value for $integral when calling ShipmentOptionsCommonReturnContributionFeeAmount., must be bigger than or equal to 0.');
        }
    ...
    public function setMicros($micros)
    {
        ...
        if (($micros > 9007199254740991)) {
            throw new \InvalidArgumentException('invalid value for $micros when calling ShipmentOptionsCommonReturnContributionFeeAmount., must be smaller than or equal to 9007199254740991.');
        }
        if (($micros < 0)) {
            throw new \InvalidArgumentException('invalid value for $micros when calling ShipmentOptionsCommonReturnContributionFeeAmount., must be bigger than or equal to 0.');
        }
