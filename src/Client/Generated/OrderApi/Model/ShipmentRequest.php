    ...
    */
    ...
    public function setCustomContractId($custom_contract_id)
    {
        ...
        if ((mb_strlen($custom_contract_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $custom_contract_id when calling ShipmentRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($custom_contract_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $custom_contract_id when calling ShipmentRequest., must be bigger than or equal to 1.');
        }
