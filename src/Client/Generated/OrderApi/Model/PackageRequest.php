...
class PackageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'lines' => '\MyParcelNL\Sdk\Client\Generated\OrderApi\Model\PackageRequestLinesInner[]',
    ...
    */
     ...
     * Gets lines
     *
     * @return \MyParcelNL\Sdk\Client\Generated\OrderApi\Model\PackageRequestLinesInner[]|null
     */
     ...
     * Sets lines
     *
     * @param \MyParcelNL\Sdk\Client\Generated\OrderApi\Model\PackageRequestLinesInner[]|null $lines lines
     *
     * @return self
     */
    public function setLines($lines)
    {
        ...
        if ((count($lines) > 100)) {
            throw new \InvalidArgumentException('invalid value for $lines when calling PackageRequest., number of items must be less than or equal to 100.');
        }
        if ((count($lines) < 1)) {
            throw new \InvalidArgumentException('invalid length for $lines when calling PackageRequest., number of items must be greater than or equal to 1.');
        }
     ...
     *
     * @param \MyParcelNL\Sdk\Client\Generated\OrderApi\Model\PhysicalPropertiesWeightRequired|null $physical_properties physical_properties
     *
     * @return self
     */
