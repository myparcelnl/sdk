...
/**
 * PackageStatusAnyOf Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\OrderApi
 * @author   OpenAPI Generator team
 ...
 */
class PackageStatusAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PackageStatus_anyOf';
    ...
    public const GROUP_PICKING_AND_PACKING = 'PICKING_AND_PACKING';
    public const NAME_PACKED = 'PACKED';
    ...
    {
        return [
            self::GROUP_PICKING_AND_PACKING,
        ];
    }
