...
/**
 * CustomsDeclarationGroupsInnerTotalValue Class Doc Comment
 *
 * @category Class
 * @description The total declared value of all items within this group.
 * @package  MyParcelNL\Sdk\Client\Generated\OrderApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomsDeclarationGroupsInnerTotalValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomsDeclaration_groups_inner_totalValue';
    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CustomsDeclarationGroupsInnerTotalValue., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CustomsDeclarationGroupsInnerTotalValue., must be bigger than or equal to 3.');
        }
    ...
    public function setFractional($fractional)
    {
        ...
        if (($fractional < 0)) {
            throw new \InvalidArgumentException('invalid value for $fractional when calling CustomsDeclarationGroupsInnerTotalValue., must be bigger than or equal to 0.');
        }
    ...
    public function setIntegral($integral)
    {
        ...
        if (($integral < 0)) {
            throw new \InvalidArgumentException('invalid value for $integral when calling CustomsDeclarationGroupsInnerTotalValue., must be bigger than or equal to 0.');
        }
    ...
    public function setMicros($micros)
    {
        ...
        if (($micros > 9007199254740991)) {
            throw new \InvalidArgumentException('invalid value for $micros when calling CustomsDeclarationGroupsInnerTotalValue., must be smaller than or equal to 9007199254740991.');
        }
        if (($micros < 0)) {
            throw new \InvalidArgumentException('invalid value for $micros when calling CustomsDeclarationGroupsInnerTotalValue., must be bigger than or equal to 0.');
        }
