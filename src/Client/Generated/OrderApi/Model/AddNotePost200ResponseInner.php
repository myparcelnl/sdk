...
/**
 * AddNotePost200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\OrderApi
 * @author   OpenAPI Generator team
 ...
 */
class AddNotePost200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_add_note_post_200_response_inner';
    ...
    */
    ...
    public function setIds($ids)
    {
        ...
        if ((count($ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ids when calling AddNotePost200ResponseInner., number of items must be greater than or equal to 1.');
        }
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 100)) {
            throw new \InvalidArgumentException('invalid length for $title when calling AddNotePost200ResponseInner., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling AddNotePost200ResponseInner., must be bigger than or equal to 1.');
        }
    ...
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling AddNotePost200ResponseInner., must be smaller than or equal to 5000.');
        }
        if ((mb_strlen($detail) < 1)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling AddNotePost200ResponseInner., must be bigger than or equal to 1.');
        }
    ...
    public function setErrors($errors)
    {
        ...
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling AddNotePost200ResponseInner., number of items must be greater than or equal to 1.');
        }
