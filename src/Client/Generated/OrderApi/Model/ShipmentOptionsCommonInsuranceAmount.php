...
/**
 * ShipmentOptionsCommonInsuranceAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentOptionsCommonInsuranceAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentOptionsCommon_insurance_amount';
    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ShipmentOptionsCommonInsuranceAmount., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ShipmentOptionsCommonInsuranceAmount., must be bigger than or equal to 3.');
        }
    ...
    public function setFractional($fractional)
    {
        ...
        if (($fractional < 0)) {
            throw new \InvalidArgumentException('invalid value for $fractional when calling ShipmentOptionsCommonInsuranceAmount., must be bigger than or equal to 0.');
        }
    ...
    public function setIntegral($integral)
    {
        ...
        if (($integral < 0)) {
            throw new \InvalidArgumentException('invalid value for $integral when calling ShipmentOptionsCommonInsuranceAmount., must be bigger than or equal to 0.');
        }
