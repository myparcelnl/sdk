...
/**
 * PhysicalPropertiesWeightRequiredLength Class Doc Comment
 *
 * @category Class
 ...
 */
class PhysicalPropertiesWeightRequiredLength implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhysicalPropertiesWeightRequired_length';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value > 1000000)) {
            throw new \InvalidArgumentException('invalid value for $value when calling PhysicalPropertiesWeightRequiredLength., must be smaller than or equal to 1000000.');
        }
        if (($value < 1)) {
            throw new \InvalidArgumentException('invalid value for $value when calling PhysicalPropertiesWeightRequiredLength., must be bigger than or equal to 1.');
        }
