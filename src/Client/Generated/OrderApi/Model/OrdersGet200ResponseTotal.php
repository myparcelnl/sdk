...
/**
 * OrdersGet200ResponseTotal Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\OrderApi
 * @author   OpenAPI Generator team
 ...
 */
class OrdersGet200ResponseTotal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_orders_get_200_response_total';
    ...
    public const RELATION_EQ = 'eq';
    public const RELATION_GTE = 'gte';
    ...
    */
     ...
     * Sets relation
     *
     * @param string $relation The relation of the total number of orders.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param int $value The total number of orders.
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if (($value < 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling OrdersGet200ResponseTotal., must be bigger than or equal to 0.');
        }
