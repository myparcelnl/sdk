...
/**
 * NoteFromPrincipal Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\OrderApi
 * @author   OpenAPI Generator team
 ...
 */
class NoteFromPrincipal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NoteFromPrincipal';
    ...
    */
    ...
    public function setPrincipal($principal)
    {
        ...
        if ((mb_strlen($principal) > 100)) {
            throw new \InvalidArgumentException('invalid length for $principal when calling NoteFromPrincipal., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($principal) < 1)) {
            throw new \InvalidArgumentException('invalid length for $principal when calling NoteFromPrincipal., must be bigger than or equal to 1.');
        }
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 2500)) {
            throw new \InvalidArgumentException('invalid length for $text when calling NoteFromPrincipal., must be smaller than or equal to 2500.');
        }
        if ((mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling NoteFromPrincipal., must be bigger than or equal to 1.');
        }
