<?php
/**
 * UnpreparePackagesForShipmentPostRequestInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UnpreparePackagesForShipmentPostRequestInner Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\OrderApi
 * @author   OpenAPI Generator team
 ...
 */
class UnpreparePackagesForShipmentPostRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_unprepare_packages_for_shipment_post_request_inner';
    ...
    */
     ...
     * Sets package_ids
     *
     * @param string[] $package_ids package_ids
     *
     * @return self
     */
    public function setPackageIds($package_ids)
    {
        ...
        if ((count($package_ids) > 25)) {
            throw new \InvalidArgumentException('invalid value for $package_ids when calling UnpreparePackagesForShipmentPostRequestInner., number of items must be less than or equal to 25.');
        }
        if ((count($package_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $package_ids when calling UnpreparePackagesForShipmentPostRequestInner., number of items must be greater than or equal to 1.');
        }
