...
/**
 * LineExternalReference Class Doc Comment
 *
 * @category Class
 * @description The external reference of the order line.
 * @package  MyParcelNL\Sdk\Client\Generated\OrderApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LineExternalReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LineExternalReference';
    ...
    */
     ...
     * Sets source_id
     *
     * @param string $source_id The order line ID as defined in the source system.
     *
     * @return self
     */
    public function setSourceId($source_id)
    {
        ...
        if ((mb_strlen($source_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $source_id when calling LineExternalReference., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($source_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $source_id when calling LineExternalReference., must be bigger than or equal to 1.');
        }
