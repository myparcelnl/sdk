...
/**
 * NoteFromImported Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\OrderApi
 * @author   OpenAPI Generator team
 ...
 */
class NoteFromImported implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NoteFromImported';
    ...
    */
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 2500)) {
            throw new \InvalidArgumentException('invalid length for $text when calling NoteFromImported., must be smaller than or equal to 2500.');
        }
        if ((mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling NoteFromImported., must be bigger than or equal to 1.');
        }
    ...
    public function setAuthor($author)
    {
        ...
        if ((mb_strlen($author) > 200)) {
            throw new \InvalidArgumentException('invalid length for $author when calling NoteFromImported., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($author) < 1)) {
            throw new \InvalidArgumentException('invalid length for $author when calling NoteFromImported., must be bigger than or equal to 1.');
        }
