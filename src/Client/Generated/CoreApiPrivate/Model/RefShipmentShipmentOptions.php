...
/**
 * RefShipmentShipmentOptions Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\CoreApiPrivate
 * @author   OpenAPI Generator team
 ...
 */
class RefShipmentShipmentOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_ref_shipment_shipment_options';
    ...
    */
    ...
    public function setDeliveryDate($delivery_date)
    {
        ...
        if ((!preg_match("/([0-9]{4})-([0-9]{2})-([0-9]{2}) ([0-9]{2}):([0-9]{2}):([0-9]{2})/", ObjectSerializer::toString($delivery_date)))) {
            throw new \InvalidArgumentException("invalid value for \$delivery_date when calling RefShipmentShipmentOptions., must conform to the pattern /([0-9]{4})-([0-9]{2})-([0-9]{2}) ([0-9]{2}):([0-9]{2}):([0-9]{2})/.");
        }
    ...
    public function setLabelDescription($label_description)
    {
        ...
        if ((mb_strlen($label_description) > 45)) {
            throw new \InvalidArgumentException('invalid length for $label_description when calling RefShipmentShipmentOptions., must be smaller than or equal to 45.');
        }
