...
namespace MyParcelNL\Sdk\Client\Generated\CoreApiPrivate;

use GuzzleHttp\Psr7\Utils;
use MyParcelNL\Sdk\Client\Generated\CoreApiPrivate\Model\ModelInterface;
            ...
            if ($data instanceof ModelInterface) {
                ...
                foreach ($data::openAPITypes() as $property => $openAPIType) {
                    ...
                    if ($value !== null && !in_array($openAPIType, ['\DateTime', '\SplFileObject', 'array', 'bool', 'boolean', 'byte', 'float', 'int', 'integer', 'mixed', 'number', 'object', 'string', 'void'], true)) {
                        // Array types are suffixed with "[]"; validate each item against the base enum class.
                        $enumType = substr($openAPIType, -2) === '[]' ? substr($openAPIType, 0, -2) : $openAPIType;
                        $callable = [$enumType, 'getAllowableEnumValues'];
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\MyParcelNL\Sdk\Client\Generated\CoreApiPrivate\Model\\' . $data->{$discriminator};
