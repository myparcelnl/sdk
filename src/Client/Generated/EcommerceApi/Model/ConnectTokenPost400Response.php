...
/**
 * ConnectTokenPost400Response Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\EcommerceApi
 * @author   OpenAPI Generator team
 ...
 */
class ConnectTokenPost400Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_connect_token_post_400_response';
    ...
    protected static $openAPITypes = [
        ...
        'instance' => 'string',
        'cause' => 'mixed',
        'errors' => '\MyParcelNL\Sdk\Client\Generated\EcommerceApi\Model\ProblemDetailsInvalidRequestSyntaxAllOfErrors[]'
    ];
    ...
    public const ERROR_USE_DPOP_NONCE = 'use_dpop_nonce';
    public const TYPE_URN_PROBLEM_INVALID_REQUEST_SYNTAX = 'urn:problem:invalid-request-syntax';
    public const STATUS_NUMBER_400 = 400;
    ...
    {
        return [
            self::TYPE_URN_PROBLEM_INVALID_REQUEST_SYNTAX,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($hasRealAllowedValues && !is_null($this->container['error']) && !in_array($this->container['error'], $allowedValues, true)) {
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 100)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ConnectTokenPost400Response., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ConnectTokenPost400Response., must be bigger than or equal to 1.');
        }
    ...
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling ConnectTokenPost400Response., must be smaller than or equal to 5000.');
        }
        if ((mb_strlen($detail) < 1)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling ConnectTokenPost400Response., must be bigger than or equal to 1.');
        }
     ...
     * Gets errors
     *
     * @return \MyParcelNL\Sdk\Client\Generated\EcommerceApi\Model\ProblemDetailsInvalidRequestSyntaxAllOfErrors[]
     */
     ...
     * Sets errors
     *
     * @param \MyParcelNL\Sdk\Client\Generated\EcommerceApi\Model\ProblemDetailsInvalidRequestSyntaxAllOfErrors[] $errors Detailed information regarding the syntactic violations.
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling ConnectTokenPost400Response., number of items must be greater than or equal to 1.');
        }
