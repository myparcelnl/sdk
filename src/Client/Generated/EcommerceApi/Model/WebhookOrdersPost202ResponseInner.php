<?php
/**
 * WebhookOrdersPost202ResponseInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * WebhookOrdersPost202ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\EcommerceApi
 * @author   OpenAPI Generator team
 ...
 */
class WebhookOrdersPost202ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_webhook_orders_post_202_response_inner';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 100)) {
            throw new \InvalidArgumentException('invalid length for $title when calling WebhookOrdersPost202ResponseInner., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling WebhookOrdersPost202ResponseInner., must be bigger than or equal to 1.');
        }
    ...
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling WebhookOrdersPost202ResponseInner., must be smaller than or equal to 5000.');
        }
        if ((mb_strlen($detail) < 1)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling WebhookOrdersPost202ResponseInner., must be bigger than or equal to 1.');
        }
     ...
     * Sets errors
     *
     * @param \MyParcelNL\Sdk\Client\Generated\EcommerceApi\Model\ProblemDetailsInvalidRequestSyntaxAllOfErrors[] $errors Detailed information regarding the violations.
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling WebhookOrdersPost202ResponseInner., number of items must be greater than or equal to 1.');
        }
