    ...
    */
    ...
    public function setAdditionalInformation($additional_information)
    {
        ...
        if ((mb_strlen($additional_information) > 100)) {
            throw new \InvalidArgumentException('invalid length for $additional_information when calling Address., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($additional_information) < 1)) {
            throw new \InvalidArgumentException('invalid length for $additional_information when calling Address., must be bigger than or equal to 1.');
        }
    ...
    public function setBoxNumber($box_number)
    {
        ...
        if ((mb_strlen($box_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $box_number when calling Address., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($box_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $box_number when calling Address., must be bigger than or equal to 1.');
        }
    ...
    public function setHouseNumber($house_number)
    {
        ...
        if ((mb_strlen($house_number) > 25)) {
            throw new \InvalidArgumentException('invalid length for $house_number when calling Address., must be smaller than or equal to 25.');
        }
        if ((mb_strlen($house_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $house_number when calling Address., must be bigger than or equal to 1.');
        }
    ...
    public function setHouseNumberSuffix($house_number_suffix)
    {
        ...
        if ((mb_strlen($house_number_suffix) > 25)) {
            throw new \InvalidArgumentException('invalid length for $house_number_suffix when calling Address., must be smaller than or equal to 25.');
        }
        if ((mb_strlen($house_number_suffix) < 1)) {
            throw new \InvalidArgumentException('invalid length for $house_number_suffix when calling Address., must be bigger than or equal to 1.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if ((mb_strlen($region) > 100)) {
            throw new \InvalidArgumentException('invalid length for $region when calling Address., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($region) < 1)) {
            throw new \InvalidArgumentException('invalid length for $region when calling Address., must be bigger than or equal to 1.');
        }
