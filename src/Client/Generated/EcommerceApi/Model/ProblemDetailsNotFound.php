...
/**
 * ProblemDetailsNotFound Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\EcommerceApi
 * @author   OpenAPI Generator team
 ...
 */
class ProblemDetailsNotFound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProblemDetailsNotFound';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 100)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ProblemDetailsNotFound., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ProblemDetailsNotFound., must be bigger than or equal to 1.');
        }
    ...
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling ProblemDetailsNotFound., must be smaller than or equal to 5000.');
        }
        if ((mb_strlen($detail) < 1)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling ProblemDetailsNotFound., must be bigger than or equal to 1.');
        }
