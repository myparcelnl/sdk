 ...
 *
 * @category Class
 * @description A monetary value represented by split integral and fractional parts to avoid floating point errors.
 * @package  MyParcelNL\Sdk\Client\Generated\EcommerceApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class SalesPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesPrice';
    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling SalesPrice., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling SalesPrice., must be bigger than or equal to 3.');
        }
    ...
    public function setMicros($micros)
    {
        ...
        if (($micros > 9007199254740991)) {
            throw new \InvalidArgumentException('invalid value for $micros when calling SalesPrice., must be smaller than or equal to 9007199254740991.');
        }
        if (($micros < 0)) {
            throw new \InvalidArgumentException('invalid value for $micros when calling SalesPrice., must be bigger than or equal to 0.');
        }
    ...
    public function setTaxRate($tax_rate)
    {
        ...
        if (($tax_rate > 100)) {
            throw new \InvalidArgumentException('invalid value for $tax_rate when calling SalesPrice., must be smaller than or equal to 100.');
        }
        if (($tax_rate < 0)) {
            throw new \InvalidArgumentException('invalid value for $tax_rate when calling SalesPrice., must be bigger than or equal to 0.');
        }
