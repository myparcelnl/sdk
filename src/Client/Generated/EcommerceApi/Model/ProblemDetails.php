...
class ProblemDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TYPE_URN_PROBLEM_NOT_FOUND = 'urn:problem:not-found';
    public const TYPE_URN_PROBLEM_SERVER = 'urn:problem:server';
    public const TYPE_URN_PROBLEM_UNAUTHORIZED = 'urn:problem:unauthorized';
    public const TYPE_URN_PROBLEM_UNSUPPORTED_MEDIA_TYPE = 'urn:problem:unsupported-media-type';
    public const STATUS_NUMBER_400 = 400;
    public const STATUS_NUMBER_401 = 401;
    public const STATUS_NUMBER_404 = 404;
    public const STATUS_NUMBER_415 = 415;
    ...
    {
        return [
            self::TYPE_ABOUT_BLANK,
            self::TYPE_URN_PROBLEM_CLIENT,
            self::TYPE_URN_PROBLEM_INVALID_REQUEST_SYNTAX,
            self::TYPE_URN_PROBLEM_NOT_FOUND,
            self::TYPE_URN_PROBLEM_SERVER,
            self::TYPE_URN_PROBLEM_UNAUTHORIZED,
            self::TYPE_URN_PROBLEM_UNSUPPORTED_MEDIA_TYPE,
        ];
    }
    ...
    public function getStatusAllowableValues()
    {
        return [
            ...
            self::STATUS_NUMBER_401,
            self::STATUS_NUMBER_404,
            self::STATUS_NUMBER_415,
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 100)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ProblemDetails., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ProblemDetails., must be bigger than or equal to 1.');
        }
    ...
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling ProblemDetails., must be smaller than or equal to 5000.');
        }
        if ((mb_strlen($detail) < 1)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling ProblemDetails., must be bigger than or equal to 1.');
        }
