...
/**
 * ConnectRefreshPost200Response Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\EcommerceApi
 * @author   OpenAPI Generator team
 ...
 */
class ConnectRefreshPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_connect_refresh_post_200_response';
    ...
    */
    ...
    public function setAccessToken($access_token)
    {
        ...
        if ((mb_strlen($access_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $access_token when calling ConnectRefreshPost200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setScope($scope)
    {
        ...
        if ((mb_strlen($scope) < 1)) {
            throw new \InvalidArgumentException('invalid length for $scope when calling ConnectRefreshPost200Response., must be bigger than or equal to 1.');
        }
