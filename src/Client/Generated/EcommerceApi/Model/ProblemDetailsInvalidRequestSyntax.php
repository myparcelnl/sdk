<?php
/**
 * ProblemDetailsInvalidRequestSyntax
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ProblemDetailsInvalidRequestSyntax Class Doc Comment
 *
 * @category Class
 * @package  MyParcelNL\Sdk\Client\Generated\EcommerceApi
 * @author   OpenAPI Generator team
 ...
 */
class ProblemDetailsInvalidRequestSyntax implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProblemDetailsInvalidRequestSyntax';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 100)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ProblemDetailsInvalidRequestSyntax., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ProblemDetailsInvalidRequestSyntax., must be bigger than or equal to 1.');
        }
    ...
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling ProblemDetailsInvalidRequestSyntax., must be smaller than or equal to 5000.');
        }
        if ((mb_strlen($detail) < 1)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling ProblemDetailsInvalidRequestSyntax., must be bigger than or equal to 1.');
        }
    ...
    public function setErrors($errors)
    {
        ...
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling ProblemDetailsInvalidRequestSyntax., number of items must be greater than or equal to 1.');
        }
