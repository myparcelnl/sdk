        ...
        <div class="col-lg-4">
            <div class="form-group">
                ...
                <select class="form-control" name="{Gett\MyParcelBE\Constant::PACKAGE_TYPE_CONFIGURATION_NAME}" id = "package-type-select">
                    <option value="1" {if $params[Gett\MyParcelBE\Constant::PACKAGE_TYPE_CONFIGURATION_NAME] == 1}selected{/if}>{l s='Package' mod='myparcel'}</option>
                    <option value="2" {if $params[Gett\MyParcelBE\Constant::PACKAGE_TYPE_CONFIGURATION_NAME] == 2}selected{/if}>{l s='Mailbox package' mod='myparcel'}</option>
                    <option value="3" {if $params[Gett\MyParcelBE\Constant::PACKAGE_TYPE_CONFIGURATION_NAME] == 3}selected{/if}>{l s='Letter' mod='myparcel'}</option>
                    <option value="4" {if $params[Gett\MyParcelBE\Constant::PACKAGE_TYPE_CONFIGURATION_NAME] == 4}selected{/if}>{l s='Digital stamp' mod='myparcel'}</option>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="{Gett\MyParcelBE\Constant::PACKAGE_FORMAT_CONFIGURATION_NAME}" id="package-type-select">
                    <option value="1" {if $params[Gett\MyParcelBE\Constant::PACKAGE_FORMAT_CONFIGURATION_NAME] == 1}selected{/if}>{l s='Normal' mod='myparcel'}</option>
                    <option value="2" {if $params[Gett\MyParcelBE\Constant::PACKAGE_FORMAT_CONFIGURATION_NAME] == 2}selected{/if}>{l s='Large' mod='myparcel'}</option>
                    <option value="3" {if $params[Gett\MyParcelBE\Constant::PACKAGE_FORMAT_CONFIGURATION_NAME] == 3}selected{/if}>{l s='Automatic' mod='myparcel'}</option>
                </select>
            </div>
            <div class="form-group">
                {if !$isBE}
        ...
        <div class="col-lg-4">
            <div class="form-group">
                ...
                <select class="form-control" id="custom-form" name = "{Gett\MyParcelBE\Constant::CUSTOMS_FORM_CONFIGURATION_NAME}">
                    <option value="No" {if $params[Gett\MyParcelBE\Constant::CUSTOMS_FORM_CONFIGURATION_NAME] == 'No'}selected{/if}>{l s='Do not automatically generate customs form' mod='myparcel'}</option>
                    <option value="Add" {if $params[Gett\MyParcelBE\Constant::CUSTOMS_FORM_CONFIGURATION_NAME] == 'Add'}selected{/if}>{l s='Add this product to customs form' mod='myparcel'}</option>
                    <option value="Skip" {if $params[Gett\MyParcelBE\Constant::CUSTOMS_FORM_CONFIGURATION_NAME] == 'Skip'}selected{/if}>{l s='Skip this product on customs form' mod='myparcel'}</option>
                </select>
            </div>
            <div class="form-group">
