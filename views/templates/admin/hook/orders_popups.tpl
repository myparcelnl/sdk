    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{l s='Print' d='Modules.Myparcel.Front'}</h5>
...
<div class="modal fade" id="bulk-print" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{l s='Close' d='Modules.Myparcel.Front'}</button>
                <button type="submit" id="print-bulk-button" class="btn btn-primary">{l s='Save changes' d='Modules.Myparcel.Front'}</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{l s='Create' d='Modules.Myparcel.Front'}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" id="print-modal">
                ...
                <div class="form-group">
                    <label for="labels_amount">{l s='Amount of labels' d='Modules.Myparcel.Front'}</label>
                ...
                <div class="insurance-additional-container">
                    <div class="form-group insurance-additional-predefined">
                        <div class="myparcel-radio-container">
                            ...
                            <label for="upto100">{l s='Up to € 100' d='Modules.Myparcel.Front'}</label>
                        </div>
                        <div class="myparcel-radio-container">
                            <input id="upto250" type="radio" value="2500" name="insurance-value-option" class="myparcel-radio">
                            <label for="upto250">{l s='Up to € 250' d='Modules.Myparcel.Front'}</label>
                        </div>
                        <div class="myparcel-radio-container">
                            <input id="upto500" type="radio" value="5000" name="insurance-value-option" class="myparcel-radio">
                            <label for="upto500">{l s='Up to € 500' d='Modules.Myparcel.Front'}</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="myparcel-radio-container">
                            <input id="heigherthen500" type="radio" value="4" class="myparcel-radio">
                            <label for="heigherthen500">{l s='Higher than € 500' d='Modules.Myparcel.Front'}</label>
                        </div>
