...
try {
    ...
    if ($printerGroups->isEmpty()) {
        echo "⚠️  No printer groups found via API.\n";
    ...
    echo "⚠️  Could not fetch printer groups: " . $e->getMessage() . "\n";
    echo "   You can manually enter a printer group ID below.\n\n";
    ...
    echo "⚠️  Missing field: " . $e->getMessage() . "\n";
    echo "   You can manually enter a printer group ID below.\n\n";
}
...
if (!$printerGroupId) {
    ...
    echo "⚠️  Skipping direct print demo. To test direct printing:\n";
...
// ============================================
if (!$printerGroupId) {
    echo "⏭️  Step 3: Skipping direct print (no printer group ID available)\n";
    echo "   To test direct printing, set a printer group ID above.\n\n";
} else {
    echo "🖨️  Step 3: Printing directly to printer...\n";
